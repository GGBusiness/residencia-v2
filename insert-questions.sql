...
-- ==========================================
-- Apenas as questões, assumindo que tabelas já existem

-- Limpar questões antigas (opcional)
...
'A',
'Suspeita de faringotonsilite estreptocócica - teste rápido ou cultura antes de antibiótico.'),
