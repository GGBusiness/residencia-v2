...
if (!pdfPath || !fs.existsSync(pdfPath)) {
    console.error('❌ Uso: npx tsx extract-pdf-direct.ts <caminho-do-pdf>');
    process.exit(1);
}
        ...
        const req = https.request(options, (res) => {
            ...
            res.on('end', () => {
                ...
                try {
                    ...
                    console.log('📊 Uso de tokens:', JSON.stringify(result.usage, null, 2));
...
extractWithClaudeDocument().catch(console.error);
